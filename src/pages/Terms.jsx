  ...
  return (
    <main className="pt-32 pb-16 md:pb-24 px-4 sm:px-6 md:px-margin-desktop max-w-4xl mx-auto">
      ...
      <div className="mb-12 pt-8 md:pt-12 border-b border-[#DFD7CA] pb-8">
        ...
        <span className="font-mono text-xs uppercase tracking-widest text-[#631B27] font-semibold block mb-2">Legal & Governance</span>
      ...
      <div className="space-y-10 font-body-md text-[#6A6258] leading-relaxed text-base sm:text-lg">
        <section>
          <h2 className="text-xl sm:text-2xl font-bold text-[#141414] mb-3">1. Agreement to Terms</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-bold text-[#141414] mb-3">2. Scope of Services</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-bold text-[#141414] mb-3">3. Intellectual Property Ownership</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-bold text-[#141414] mb-3">4. Confidentiality & Non-Disclosure</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-bold text-[#141414] mb-3">5. AI Solutions & Automated Workflows</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-bold text-[#141414] mb-3">6. Payment Terms & Invoicing</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-bold text-[#141414] mb-3">7. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-bold text-[#141414] mb-3">8. Governing Law & Contact</h2>
          <p>
            ...
            or call{" "}
            <a href="tel:+918714196266" className="text-[#631B27] hover:text-[#782231] font-medium underline transition-colors">
              +91 87141 96266
            </a>.
          </p>
        </section>
